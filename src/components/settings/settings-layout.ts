export const SETTINGS_SHEET_CLASSNAMES = {
  ...
  contentPanel:
    'fixed top-1/2 left-1/2 z-50 flex w-[min(680px,calc(100vw-4rem))] max-w-[720px] min-w-[600px] max-h-[min(540px,calc(100vh-6rem))] -translate-x-1/2 -translate-y-1/2 rounded-xl bg-popover/94 backdrop-blur-xl p-0 text-sm text-popover-foreground ring-1 ring-foreground/8 outline-none shadow-2xl',
